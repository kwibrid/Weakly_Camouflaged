...
class Pred_endecoder(nn.Module):
    ...
    def __init__(self, channel):
        ...
        self.pred_dec = Pred_decoder(channel)
        self.alea_unc = Pred_decoder(channel)
    ...
    def forward(self, x):
        ...
        pred = self.pred_dec(x1,x2,x3,x4)
        alea = self.alea_unc(x1,x2,x3,x4)
